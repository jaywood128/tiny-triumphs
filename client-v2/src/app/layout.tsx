...
export default function RootLayout({
  ...
  useEffect(() => {
    async function validateJwt() {
      try {
        console.log(
          `validateJwt token: ${window.localStorage.getItem('token')}`
        );
        if (token === '') {
          return;
        }
                    ...
                    <div className="hidden sm:ml-6 sm:block">
                      <div className="flex space-x-4">
                        ...
                        <Link
                          ...
                          as={`/users/1/todos`}
                          aria-controls="mobile-menu"
                          className="border-solid rounded-md border-2 border-customRed bg-customerRed hover:bg-customRed text-white px-3 py-2 text-sm font-medium"
                          aria-current="page"
                        >
                          Todo Items
                        </Link>
